...
#-------------------
 data modify storage mpmelee:settings bow.enable set value true
#>-------------------
...
#-------------------
 data modify storage mpmelee:settings bow.spread set value {radius:{min:0.5, max:3.5}, magnitude:{min:-0.1, max:0.2}}
#>-------------------
...
#-------------------
 data modify storage mpmelee:settings bow.can_crit set value true
#>-------------------
...
#-------------------
 data modify storage mpmelee:settings crossbow.enable set value true
#>-------------------
...
#: {radius:{min: float, max: float}, magnitude:{min: float, max: float}}
#-------------------
#~ same as {mpmelee:settings -> bow.spread}, but for crossbow.
#-------------------
 data modify storage mpmelee:settings crossbow.spread set value {radius:{min:0f, max:0f}, magnitude:{min:0f, max:0f}}
#>-------------------
...
#- true is vanilla behavior.
#-------------------
 data modify storage mpmelee:settings crossbow.can_crit set value false
#>-------------------