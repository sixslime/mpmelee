...
data modify storage mpweapons:var register.attributes append value {type:"minecraft:attack_damage", operation:"add_value"}
...
data modify storage mpweapons:var register.attributes append value {type:"minecraft:attack_knockback", operation:"add_value"}
...
data modify storage mpweapons:var register.attributes append value {type:"minecraft:attack_speed", operation:"add_multiplied_base"}
...
data modify storage mpweapons:var register.attributes append value {type:"minecraft:entity_interaction_range", operation:"add_multiplied_base"}
